...
#all types of string in all types of files
from __future__ import absolute_import
#using print as a function
from __future__ import print_function
#for reading our simulation in sumo
from sumolib import checkBinary
#for making DNN , its calculates and for deep and machine learning
...
if __name__ == '__main__':
    ...
    for e in range(episodes):
        ...
        log.write(f'episode - {e}, total waiting time - {waiting_time}, static waiting time - 338798, total reward: {total_reward}\n')
        log.close()
        print('episode - ' + str(e) + ' total waiting time - ' + str(waiting_time)+" total_reward:"+str(total_reward))
